...
export const ListProductsResponseItem = zod.object({
  ...
  "imageUrl": zod.string().describe('Public URL or storage object path for the product image (primary\/first)'),
  "imageUrls": zod.array(zod.string()).nullish().describe('All product images (gallery); the first mirrors imageUrl.'),
...
export const SearchProductsResponseItem = zod.object({
  ...
  "deliveryNote": zod.string().nullish().describe('Merchant note about delivery coverage (which areas the listed prices cover; anywhere else costs 5,000). Shown in the cart.'),
...
export const CreateStoreBody = zod.object({
  ...
  "deliveryNote": zod.string().nullish().describe('Merchant note about delivery coverage shown to customers in the cart.'),
  "trial": zod.boolean().optional().describe('When true, the store requests a free 10-day trial — it still waits for admin approval; on approval the admin activates it with a 10-day expiry.')
})
...
export const ListStoreOrdersResponseItem = zod.object({
  ...
  "deliveryType": zod.enum(['standard', 'express', 'outside']),
